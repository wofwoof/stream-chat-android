...
:::note
A guide on how to read the following reports can be found [here](https://developer.android.com/studio/profile/macrobenchmark-metrics#frame-timing) in the official Macrobenchmark documentation.
:::
